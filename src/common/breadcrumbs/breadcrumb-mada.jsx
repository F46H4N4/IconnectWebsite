...
const BreadcrumbEight = () => {
   ...
   const text = "DietErp: Personalized, allergen-free meals delivered to your door for a healthier lifestyle!";
      ...
      <>
         ...
         >
            ...
            <div className="container">
                  ...
                  <div className="row justify-content-center">
                     <div className="col-xl-12">
                      ...
                      <div className="breadcrumb__text wow tpfadeIn" data-wow-duration=".9s" data-wow-delay=".6s">
                        <span><img src="assets/img/logo/diet.png" alt="theme pure"/>
               ...
               <Link href="https://www.diet-erp.com/"
                   style={{
                  color: '#ffffff',
                  fontWeight: 'bold',
                  textDecoration: 'none',
